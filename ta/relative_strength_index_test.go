...
var _ = Describe("RSI", func() {
	It("should return the correct values", func() {
		in := toCloses([]float64{26.0, 54.0, 8.0, 77.0, 61.0, 39.0, 44.0, 91.0, 98.0, 17.0})
	...
	It("should return the correct again", func() {
		in := toCloses([]float64{417.26, 419.34, 417.96, 417.4, 418.1, 417.61, 415.1, 414.34, 420.44, 420.77, 418.21, 418.86, 416.36, 412.64, 418.13, 414.96, 415.48, 414.99, 414.96, 410.34, 411.62, 408.78, 409.53, 413.85, 413.84, 413.82, 411.09, 413.77, 413.76})
